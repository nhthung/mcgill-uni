...
if display, 
   disp(' ');
   disp('   n             a                       b                       c                      f(c)                error_bound');
   disp(' ');
   disp(sprintf('%4d %23.15e %23.15e %23.15e %23.15e %23.15e', n, a, b, c, fc, e_bound))
end
while e_bound > delta
   if fc == 0, 
      root = c;
   ...
   e_bound = e_bound/2;
   n = n + 1;
   if display, disp(sprintf('%4d %23.15e %23.15e %23.15e %23.15e %23.15e', n, a, b, c, fc, e_bound)), end
end
root = c;
